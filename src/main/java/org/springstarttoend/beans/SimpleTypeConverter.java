...
import org.springstarttoend.beans.propertyeditors.CustomBooleanEditor;
import org.springstarttoend.beans.propertyeditors.CustomNumberEditor;
...
//                    throw new TypeMismatchException(value,requiredType);
    ...
    private PropertyEditor getDefaultEditor(Class<?> requiredTyep) {
        if(this.defaultEditors == null){
            createDefaultEditors();
        }
        return this.defaultEditors.get(requiredTyep);
    }
